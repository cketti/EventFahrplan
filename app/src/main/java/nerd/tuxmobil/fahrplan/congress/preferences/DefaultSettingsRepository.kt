...
internal class DefaultSettingsRepository(
    ...
    override suspend fun setUseDeviceTimeZone(enable: Boolean) {
        preferences.edit {
    ...
    override suspend fun setAlternativeHighlighting(enable: Boolean) {
        preferences.edit {
    ...
    override suspend fun setFastSwiping(enable: Boolean) {
        preferences.edit {
    ...
    override suspend fun setAlarmTone(alarmToneUri: String?) {
        preferences.edit {
    ...
    override suspend fun setInsistentAlarms(enable: Boolean) {
        preferences.edit {
    ...
    override suspend fun setAlarmTime(alarmTime: Int) {
        preferences.edit {
    ...
    override suspend fun setScheduleRefreshInterval(interval: Int) {
        preferences.edit {
    ...
    override suspend fun setAutoUpdateEnabled(enable: Boolean) {
        preferences.edit {
    ...
    override suspend fun setAlternativeScheduleUrl(url: String) {
        preferences.edit {
    ...
    override suspend fun setEngelsystemShiftsUrl(url: String) {
        preferences.edit {
